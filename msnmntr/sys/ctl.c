...
NTSTATUS MonitorCtlCreate (IN PDEVICE_OBJECT deviceObject, IN PIRP irp);

__drv_dispatchType(IRP_MJ_CLOSE) DRIVER_DISPATCH MonitorCtlClose;
NTSTATUS MonitorCtlClose (IN PDEVICE_OBJECT deviceObject, IN PIRP irp);

__drv_dispatchType(IRP_MJ_CLEANUP) DRIVER_DISPATCH MonitorCtlCleanup;
NTSTATUS MonitorCtlCleanup (IN PDEVICE_OBJECT deviceObject, IN PIRP irp);

__drv_dispatchType_other DRIVER_DISPATCH MonitorCtlDispatchRequest;
NTSTATUS MonitorCtlDispatchRequest (IN PDEVICE_OBJECT deviceObject, IN PIRP irp);

__drv_dispatchType(IRP_MJ_DEVICE_CONTROL) DRIVER_DISPATCH MonitorCtlDeviceControl;
NTSTATUS MonitorCtlDeviceControl (IN PDEVICE_OBJECT deviceObject, IN PIRP irp);


NTSTATUS MonitorCtlDriverInit(IN  PDRIVER_OBJECT  driverObject)
/*++
Routine Description:
